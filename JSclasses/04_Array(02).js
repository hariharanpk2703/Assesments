...
// find out the total salary that needs to be paid.
//***********************
// let arr1 = salary.filter(value => value > 300);
// console.log(arr1);
//*********************
// let arr2 = [];
...
//********************************
// let totalSalary = salary.reduce((acc, current) => acc = acc+ current, 0);

//************************
// let salary = [100, 200, 300, 400, 500, 600];

// let greaterSalary = salary.filter(item => item>300);
// console.log("salaries greater than 300",greaterSalary);

// let doubleSalary = greaterSalary.map(item => item*2)
// console.log("double of filtered salaries",doubleSalary)

// let totalSalary = salary.reduce((sum,item)=>{
//     return sum+=item
// }, 0)
// console.log("total salary that needs to be paid.",totalSalary)
